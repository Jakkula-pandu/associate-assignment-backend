...
exports.fetchAssessments = async ( page, size, search,limit,offset,batch_id) => {
  let assessment = await assessmentDbLayer.fetchAllAssessments( page, size, search,limit,offset,batch_id);
